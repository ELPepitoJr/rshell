	...
	else //final product for instructors
	{
		...
		while(true)
		{
			...
			while(!inSS.eof() )
			{
			    ...
			    else if(arg == "sort" || arg == "uniq" || arg == "fmt" || arg == "pr" || arg == "tr"
		       || arg == "head" || arg == "tail" || arg == "awk" || arg == "ls" || arg == "cat" || arg == "grep")
		       {
		       	 if(inSS.eof()) 
		       	 { 
		       	 	Executable* entry = new Direction(arg, 'n', 'c');
		       	 	exec->insert(entry, "null");
		       	 	break; 
		       	 }
		       	 ...
		       	 if(!inSS.eof())
		       	 {
		       	 	...
		       	 	if(arg == "tr" || arg == "grep")
		       	 	{
		       	 		...
		       	 		if(inSS.eof()) 
				       	 { 
				       	 	Executable* entry = new Direction(hold_s, 'n', 'c');
				       	 	exec->insert(entry, "null");
				       	 	break; 
				       	 }
		       	 		...
		       	 		if(arg2 == "|")
			       	 	{
			       	 		Executable* entry = new Direction(hold_s, 'n', 'p');
			       	 		exec->insert(entry, hold_s);
			       	 	}
			       	 	else if(arg2 == ">>")
			       	 	{
			       	 		inSS >> arg2;
			       	 		Executable* entry = new Direction(hold_s, arg2, 'n', 'a');
			       	 		exec->insert(entry, hold_s);
			       	 	}
			       	 	else if (arg2 == ">")
			       	 	{
			       	 		inSS >> arg2;
			       	 		Executable* entry = new Direction(hold_s, arg2, 'n', 'w');
			       	 		exec->insert(entry, hold_s);
			       	 	}
			       	 	else if(arg2 == "<")
			       	 	{
			       	 		inSS >> arg2;
			       	 		Executable* entry = new Direction(hold_s, 'n', 'i');
			       	 		exec->insert(entry, hold_s);
			       	 	}
		       	 	}
		       	 	else 
		       	 	{
			       	 	if(arg2 == "|")
			       	 	{
			       	 		Executable* entry = new Direction(arg, 'n', 'p');
			       	 		exec->insert(entry, "null");
			       	 	}
			       	 	else if(arg2 == ">>")
			       	 	{
			       	 		inSS >> arg2;
			       	 		Executable* entry = new Direction(arg, arg2, 'n', 'a');
			       	 		exec->insert(entry, "null");
			       	 	}
			       	 	else if (arg2 == ">")
			       	 	{
			       	 		inSS >> arg2;
			       	 		Executable* entry = new Direction(arg, arg2, 'n', 'w');
			       	 		exec->insert(entry, "null");
			       	 	}
			       	 	else if(arg2 == "<")
			       	 	{
			       	 		Executable* entry = new Direction(arg, 'n', 'i');
			       	 		exec->insert(entry, "null");
			       	 	}
		       	 	}
				...
				else if (arg.find("&&") == 0) //if a double Ampersand is found countains no other characters
				{
